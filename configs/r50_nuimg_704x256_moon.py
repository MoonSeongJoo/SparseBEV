...
model = dict(
    ...
    #         cls_cost=dict(type='FocalLossCost', weight=0.15),
...
data = dict(
    ...
    train=dict(
        ...
        # ann_file=dataset_root + 'radar_nuscenes_5sweeps_infos_train_radar.pkl',
    ...
    val=dict(
        ...
        # ann_file=dataset_root + 'radar_nuscenes_5sweeps_infos_val_radar.pkl',

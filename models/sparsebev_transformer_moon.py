...
class SparseBEVTransformer(BaseModule):
    ...
    def forward(self, query_bbox, query_feat,mlvl_feats, pts_feats, attn_mask, img_metas):
        cls_scores, bbox_preds = self.decoder(query_bbox, query_feat, mlvl_feats, pts_feats, attn_mask, img_metas)
    ...
    def forward(self, query_bbox, query_feat, mlvl_feats,pts_feats,attn_mask, img_metas):
        ...
        for i in range(self.num_layers):
            ...
            query_feat, cls_score, bbox_pred = self.decoder_layer(
                query_bbox, query_feat, mlvl_feats,pts_feats, attn_mask, img_metas
            )

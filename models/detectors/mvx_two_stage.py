...
from mmdet3d.models import (build_voxel_encoder,build_middle_encoder,
                            build_backbone,build_fusion_layer,build_neck,build_head,
                            )
...
class MVXTwoStageDetector(Base3DDetector):
    ...
    def __init__(self,
        ...
        # self.init_weights(pretrained=pretrained) # old version
        self.init_weights()
